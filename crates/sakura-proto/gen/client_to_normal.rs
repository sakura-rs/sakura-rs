...
impl From<crate::client::SyncScenePlayTeamEntityNotify>
for SyncScenePlayTeamEntityNotify {
    fn from(value: crate::client::SyncScenePlayTeamEntityNotify) -> Self {
        Self {
...
impl From<crate::client::PlayTeamEntityInfo> for PlayTeamEntityInfo {
    fn from(value: crate::client::PlayTeamEntityInfo) -> Self {
        Self {
...
impl From<crate::client::ForceUpdateInfo> for ForceUpdateInfo {
    fn from(value: crate::client::ForceUpdateInfo) -> Self {
        Self {
...
impl From<crate::client::QueryCurrRegionHttpRsp> for QueryCurrRegionHttpRsp {
    fn from(value: crate::client::QueryCurrRegionHttpRsp) -> Self {
        Self {
            retcode: value.retcode.into(),
            msg: value.msg.into(),
...
impl From<crate::client::query_curr_region_http_rsp::Detail>
for query_curr_region_http_rsp::Detail {
    fn from(value: crate::client::query_curr_region_http_rsp::Detail) -> Self {
        match value {
            crate::client::query_curr_region_http_rsp::Detail::ForceUpdate(v) => {
                Self::ForceUpdate(v.into())
            }
            crate::client::query_curr_region_http_rsp::Detail::StopServer(v) => {
...
impl From<crate::client::NpcTalkRsp> for NpcTalkRsp {
    fn from(value: crate::client::NpcTalkRsp) -> Self {
        Self {
...
impl From<crate::client::RegionSimpleInfo> for RegionSimpleInfo {
    fn from(value: crate::client::RegionSimpleInfo) -> Self {
        Self {
...
impl From<crate::client::NpcTalkReq> for NpcTalkReq {
    fn from(value: crate::client::NpcTalkReq) -> Self {
        Self {
            npc_entity_id: value.npc_entity_id.into(),
            entity_id: value.entity_id.into(),
...
impl From<crate::client::WindSeedClientNotify> for WindSeedClientNotify {
    fn from(value: crate::client::WindSeedClientNotify) -> Self {
        Self {
...
impl From<crate::client::wind_seed_client_notify::Notify>
for wind_seed_client_notify::Notify {
    fn from(value: crate::client::wind_seed_client_notify::Notify) -> Self {
        match value {
            crate::client::wind_seed_client_notify::Notify::AddWindBulletNotify(v) => {
                Self::AddWindBulletNotify(v.into())
            }
            crate::client::wind_seed_client_notify::Notify::AreaNotify(v) => {
                Self::AreaNotify(v.into())
            }
            crate::client::wind_seed_client_notify::Notify::RefreshNotify(v) => {
...
impl From<crate::client::RefreshNotify> for RefreshNotify {
    fn from(value: crate::client::RefreshNotify) -> Self {
        Self {
...
impl From<crate::client::AddWindBulletNotify> for AddWindBulletNotify {
    fn from(value: crate::client::AddWindBulletNotify) -> Self {
        Self { ..Default::default() }
    }
}
impl From<crate::client::AreaNotify> for AreaNotify {
    fn from(value: crate::client::AreaNotify) -> Self {
        Self {
...
impl From<crate::client::ability_string::Type> for ability_string::Type {
    fn from(value: crate::client::ability_string::Type) -> Self {
        match value {
            crate::client::ability_string::Type::Str(v) => Self::Str(v.into()),
            crate::client::ability_string::Type::Hash(v) => Self::Hash(v.into()),
            _ => unreachable!(),
        }
    }
}
...
impl From<crate::client::AbilityIdentifier> for AbilityIdentifier {
    fn from(value: crate::client::AbilityIdentifier) -> Self {
        Self {
            instanced_modifier_id: value.instanced_modifier_id.into(),
            instanced_ability_id: value.instanced_ability_id.into(),
            is_serverbuff_modifier: value.is_serverbuff_modifier.into(),
...
impl From<crate::client::RegionInfo> for RegionInfo {
    fn from(value: crate::client::RegionInfo) -> Self {
        Self {
...
impl From<crate::client::StopServerInfo> for StopServerInfo {
    fn from(value: crate::client::StopServerInfo) -> Self {
        Self {
...
impl From<crate::client::SceneForceUnlockNotify> for SceneForceUnlockNotify {
    fn from(value: crate::client::SceneForceUnlockNotify) -> Self {
        Self {
...
impl From<crate::client::ScenePointUnlockNotify> for ScenePointUnlockNotify {
    fn from(value: crate::client::ScenePointUnlockNotify) -> Self {
        Self {
...
impl From<crate::client::UnlockTransPointReq> for UnlockTransPointReq {
    fn from(value: crate::client::UnlockTransPointReq) -> Self {
        Self {
...
impl From<crate::client::GetAreaExplorePointRsp> for GetAreaExplorePointRsp {
    fn from(value: crate::client::GetAreaExplorePointRsp) -> Self {
        Self {
            area_id_list: value.area_id_list.into_iter().map(|v| v.into()).collect(),
...
impl From<crate::client::SceneEntityDisappearNotify> for SceneEntityDisappearNotify {
    fn from(value: crate::client::SceneEntityDisappearNotify) -> Self {
        Self {
            param: value.param.into(),
            entity_list: value.entity_list.into_iter().map(|v| v.into()).collect(),
...
impl From<crate::client::ResVersionConfig> for ResVersionConfig {
    fn from(value: crate::client::ResVersionConfig) -> Self {
        Self {
            version: value.version.into(),
...
impl From<crate::client::EntityFightPropNotify> for EntityFightPropNotify {
    fn from(value: crate::client::EntityFightPropNotify) -> Self {
        Self {
            entity_id: value.entity_id.into(),
            fight_prop_map: value
                .fight_prop_map
...
impl From<crate::client::QueryRegionListHttpRsp> for QueryRegionListHttpRsp {
    fn from(value: crate::client::QueryRegionListHttpRsp) -> Self {
        Self {
            retcode: value.retcode.into(),
...
impl From<crate::client::GetAreaExplorePointReq> for GetAreaExplorePointReq {
    fn from(value: crate::client::GetAreaExplorePointReq) -> Self {
        Self {
            area_id_list: value.area_id_list.into_iter().map(|v| v.into()).collect(),
            ..Default::default()
        }
